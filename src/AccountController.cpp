...
void AccountController::poll() { pollNotifications(); }
...
void AccountController::coinsClicked() { this->loadPanel("coins"); }

void AccountController::sendClicked() { this->loadPanel("send"); }

void AccountController::receiveClicked() { this->loadPanel("receive"); }

void AccountController::settingsClicked() { this->loadPanel("settings"); }

auto AccountController::simulateTx(TransactionTemplate tx)
...
void AccountController::updateCoinLabel(const QString &outpoint,
                                        const QString &label) {
  if (m_account.has_value()) {
    try {
